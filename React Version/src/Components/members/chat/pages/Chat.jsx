    ...
    axios
      ...
      .then((response) => {
        ...
        if (data.error) {
          ...
          if(data.user_profile.profile_picture == undefined) setUserProfilePicture("http://localhost:3000/images/default.jpeg")
          else setUserProfilePicture(data.user_profile.profile_picture)
        }
      })
      .catch((error) => {
        console.error(error);
