...
module.exports.getAllJobs = async (request, response, next) => {
  try {
...
module.exports.searchJobs = async (request, response) => {
...
module.exports.searchResults = async (request, response) => {
  try {
...
module.exports.jobDetails = async(request, response) => {
...
module.exports.getSeller = async(request, response) => {
...
module.exports.makePayment = async (request, response) => {
        const { 
          client_id, 
          clientEmail, 
          freelancer_id, 
        ...
        if (!client_id) {
          return response.json({ error: "You aren't authorized to make this transaction" });
        }
...
//Admin section
module.exports.countJobs = async(request, response) => {
  try{
...
module.exports.countServices = async(request, response) => {
  try{
...
module.exports.countJobsInCategory = async (request, response) => {
  try {
...
module.exports.countCategories = async (request, response) => {
  try {
...
module.exports.countInvoices = async (request, response) => {
  try {
...
module.exports.countInvoiceDates = async (request, response) => {
  try {
...
module.exports.updateServices = async (request, response) => {
...
module.exports.deleteServices = async (request, response) => {
